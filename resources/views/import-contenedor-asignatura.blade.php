...
<head>
    ...
    <title>Asociar estudiantes en asignaturas</title>
...
<body>
            ...
            <div class="row justify-content-center">
                <div class="card justify-content-center">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" enctype="multipart/form-data" action="{{route('Contenedor_Asignatura.import')}}">
                            @csrf
    ...
    <section class = "container d-flex justify-content-center py-2 mt-2" >
        <h2>Lista de estudiantes asociados</h2>
    </section>
    ...
    <section class = "d-flex py-2 mt-2 justify-content-center">
        ...
        <table  class="table table-responsive table-bordered" , border ="2">
            ...
            @foreach ($contenedor_asignaturas as $contenedor_asignatura)
            <tr>

                <td>{{$contenedor_asignatura['nrc_asignatura']}}</td>
                <td>{{$contenedor_asignatura['rut_alumno']}}</td>
