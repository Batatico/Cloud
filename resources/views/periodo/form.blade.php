    ...
    <nav class ="navbar navbar-light navbar-expand-md fixed-top" style ="background-color: #003057"  >
      ...
      <link rel="stylesheet" href="{{ asset('css/style.css') }}" />
        ...
        <h4 class ="text-center">Editar Asignatura</h4>
            <input class="controls" type="text" name="nombres" id="nombres" placeholder="Código semestre" required>
            <input class="controls" type="text" name="apellidos" id="apellidos" placeholder="Descripción" required>
            
            <p>Revise que los datos ingresados son correctos</p>
