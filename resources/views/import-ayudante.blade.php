            ...
            <div class="row justify-content-center">
                <div class="card justify-content-center">
                    <div class="card-header py-2 mt-2 text-center justify-content-center">
                       <h3> Carga Masiva de ayudantes </h3>
                    </div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        @endif
                        <form method="POST" enctype="multipart/form-data" action="{{route('ayudante.import')}}">
                            @csrf
    ...
    <section class = "d-flex py-2 mt-2 justify-content-center">
        ...
        <table  class="table table-responsive table-bordered" , border ="2">
            ...
            <tr>
                ...
                <td>{{$ayudante['rut_alumno']}}</td>
                <td>{{$ayudante['nrc_asignatura']}}</td>
