...
<nav class ="navbar navbar-light navbar-expand-md fixed-top" style ="background-color: #003057"  >
    <a class = "btn" href="{{url('/graficos')}}" style="color:#fff">
                ...
                <tr>
                    ...
                    <div class= "text-center">
                        <div class="container flex btn-group justify-content-between">
                            <div>
                            <form action="{{route('consolidadoGrafico', $encuesta->id_pregunta)}}" method="post"> 
                             @csrf    
                            {{method_field('GET')}}
                            <button class = "btn btn-primary" type="submit">desplegar Grafico</button>
                            </form>
                            </div>
